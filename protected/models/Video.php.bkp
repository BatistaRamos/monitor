...
class Video extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('descricao, url, nome_contato, email_contato, telefone_contato', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, nome, descricao, url, nome_contato, email_contato, telefone_contato', 'safe', 'on'=>'search'),
		);
	}
